...
/*==================================================================
1) Base Data Prep: Retrieves core columns from fact_sales and dim_costumers
==================================================================*/
select 
f.order_number, 
f.product_key,
...
costumer_aggregations as (
/*==================================================================
2) Costumer aggregations: Summarizies key metrics at the costumer level
==================================================================*/
select customer_key,
customer_number,
customer_name,
